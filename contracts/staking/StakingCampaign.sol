...
contract StakingCampaign is ERC1155, Ownable {
    ...
    function changeEpoch(uint32 beginEpoch_, uint32 endEpoch_) external onlyOwner {
        beginEpoch = beginEpoch_;
        endEpoch = endEpoch_;
    }
    ...
    function uri(uint256 id) public view override supportedID(id) returns (string memory) {
